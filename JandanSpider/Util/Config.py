...
SEUserAgents = [
    ...
    "Googlebot-Image/1.0",  # google image
    "Mozilla/5.0 (compatible; Baiduspider/2.0; +http://www.baidu.com/search/spider.html)",  # baidu
    "Baiduspider-image+(+http://www.baidu.com/search/spider.htm)",  # baidu image
    "Mozilla/5.0 (Windows; U; Windows NT 5.1; zh-CN; rv:1.9.2.8;baidu Transcoder) Gecko/20100722 Firefox/3.6.8 (.NET CLR 3.5.30729)",
    # baidu mobile
    "Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Trident/5.0); 360Spider",  # 360
    "Mozilla/5.0 (compatible; bingbot/2.0; +http://www.bing.com/bingbot.htm)",  # bing
    "Sosospider+(+http://help.soso.com/webspider.htm)",  # 搜搜spider
    "Sosoimagespider+(+http://help.soso.com/soso-image-spider.htm)",  # 搜搜图片
    "Mozilla/5.0 (compatible; Yahoo! Slurp China; http://misc.yahoo.com.cn/help.html)",  # yahoo China
    "Mozilla/5.0 (compatible; Yahoo! Slurp; http://help.yahoo.com/help/us/ysearch/slurp)",  # yahoo English
]
UserAgents = [
